...
<div id="header" class="wrap">
	<div id="logo"><img src="<%=basePath%>/main/WebRoot/images/logo.gif" /></div>
</div>
				...
				<div class="infos">				
					<table class="field">
						...
						<tr>
							...
							<td>
								<input type="text" class="text" name="users.username" />
							</td>
						</tr>
						<tr>
							<td class="field">密　　码：</td>
							<td>
								<input type="password" class="text" name="users.password" />
							</td>
						</tr>						
					</table>
